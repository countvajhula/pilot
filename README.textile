...
More documentation is on the way! For now, the demo app TestFlight.groovy should help you get started. Also, looking at GraphInterface.groovy would be a way to get familiar with the API.
