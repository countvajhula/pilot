...
Currently, the supported graphdb providers are "OrientDB":http://www.orientechnologies.com and "Neo4j":http://neo4j.org, but others may be added in future if there is demand.
